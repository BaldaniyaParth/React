...
export default function Counter() {
   // const [stateVariable, setStateVariable] = useState(0);
    ...
    let incCount = () => {
        ...
        // setCount(count+1); }
    //                          } it will only increase count to +1 (2 time same call but increase only 1 time)
        // setCount(count+1); } 
        ...
        //    return currCount+1;
        // })
    //                                  } - now this will increase count to + 2 (this type write the setCount function so 2 time same call and increse the 2 time)
        // setCount((currCount) => {
        //     return currCount+1;
        // }) 
